  ...
  return (
    <footer className="relative flex min-h-[82svh] flex-col justify-end overflow-hidden border-t border-champagne/10">
      ...
      <Reveal className="relative z-10 mx-auto mb-16 mt-5 flex max-w-md flex-col items-center gap-4 px-6 text-center">
        ...
        <p className="text-xs uppercase tracking-[0.28em] text-pearl/70">
          With love & blessings, {wedding.familySignoff}
        </p>
        ...
        <motion.button
          ...
          onClick={copyHashtag}
          whileTap={{ scale: 0.94 }}
          className={`rounded-full border px-4 py-2 text-[11px] uppercase tracking-[0.2em] transition-colors duration-500 ease-[cubic-bezier(.16,1,.3,1)] ${
            copied
              ? "border-glow-warm/60 bg-glow-warm/10 text-glow-warm"
              : "border-moon/35 bg-white/5 text-pearl/70 hover:border-gold hover:text-gold"
          }`}
        >
